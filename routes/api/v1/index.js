...
const RepotedUsersController = require("../../../Controller/User/ReportUser");
const RepotedEventController = require("../../../Controller/User/ReportEvent");
const BlockUserController = require("../../../Controller/User/BlockUser");
...
const {
  ...
  deleteMessage,
  isSeenMessage,
} = require("../../../Controller/User/Message");
const {
  viewAllOrganizerActive,
} = require("../../../Controller/Organizer/Active");
const {
  viewAllUserActive,
  viewAllUserPendingActive,
  UpdateAllActiveSeen,
} = require("../../../Controller/User/Active");
const { PayNowSplitDue } = require("../../../Controller/Organizer/Payment");
const { sendSms } = require("./../../../service/Twilio");
...
router.get("/city/new/update-timezone", CommonController.updateTimezone); // testing
...
router.delete(
  ...
  userUserController.DeletePaymentMethod
);

router.get("/user/active", viewAllUserActive);
router.get("/user/active/pending-activity", viewAllUserPendingActive);
router.put("/user/active/update-all", UpdateAllActiveSeen);
...
router.post(
  "/user/event/booking-cancel",
  EventUserController.eventBookingCancel
);
...
router.delete(
  "/user/event/split-user/:id",
  EventUserController.SplitUserDelete
);
...
router.post("/user/report", RepotedUsersController.create);
router.put("/user/report/:id", RepotedUsersController.update);
router.get("/user/report-list", RepotedUsersController.RepotedUsers);

router.post("/user/report-event", RepotedEventController.create);
router.put("/user/report-event/:id", RepotedEventController.update);
router.get("/user/report-event-list", RepotedEventController.RepotedEvents);

router.post("/user/block-user", BlockUserController.create);
router.put("/user/block-user/:id", BlockUserController.update);
router.get("/user/block-user-list", BlockUserController.BlockedUsers);
...
router.post(
  "/organizer/upload",
  upload.single("image"),
  OrganizerController.profilePicUpload
);
...
router.get(
  "/organizer/event/special-guests",
  EventOrganizerController.GetSpecialGuestsName
);
router.post("/organizer/event/code-check", EventOrganizerController.CheckCode);

router.get(
  "/organizer/event/booking-his",
  EventOrganizerController.viewAllBookingHis
);
...
router.post(
  "/organizer/event/upload",
  upload.single("image"),
  EventOrganizerController.ImageUpload
);
router.get(
  "/organizer/event/booking/:id",
  EventOrganizerController.viewAllBooking
);
router.put(
  "/organizer/event/booking/:id",
  EventOrganizerController.BookingConfrim
);
router.get("/organizer/event/qr-code/:id", EventOrganizerController.QrBooking);
router.post("/organizer/event/qr-code", EventOrganizerController.QrBookingNew);
router.post(
  "/organizer/event/qr-code-scan-success",
  EventOrganizerController.UpdateQqScan
);
...
router.get(
  "/organizer/table-list/:id",
  TableListOrganizerController.viewSingel
);
...
router.get(
  "/organizer/promotions/:id",
  PromotionsOrganizerController.viewSingel
);
router.put("/organizer/promotions/:id", PromotionsOrganizerController.update);
router.delete(
  "/organizer/promotions/:id",
  PromotionsOrganizerController.Delete
);
...
router.post(
  "/admin/user/upload",
  upload.single("image"),
  UserAdminController.ImageUpload
);
...
router.post(
  "/admin/organizer/upload",
  upload.single("image"),
  OrganizerAdminController.ImageUpload
);
...
router.post(
  "/admin/event/upload",
  upload.single("image"),
  EventAdminController.ImageUpload
);
...
router.get(
  "/admin/event-review/:eventId",
  EventReviewAdminController.viewAllByEvent
);
router.get(
  "/admin/event-review/:orgazierId",
  EventReviewAdminController.viewAllByEvent
);
